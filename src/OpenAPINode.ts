/**
 * @file Contains the constructor function for the OpenAPI nodes.
 */
import { LiteGraph } from "litegraph.js";

/**
 * Constructor function for OpenAPI nodes. It creates inputs/outputs and other node
 * properties based on the OpenAPI operation.
 * @param method - HTTP method of the operation.
 * @param path - Path of the operation.
 * @param operation - The OpenAPI operation object.
 */
function OpenAPINode(this: any, method: string, path: string, operation: any) {
...
export function createOpenAPINodeClass(method: string, path: string, operation: any) {
  const NodeClass = function () {
    OpenAPINode.call(this, method, path, operation);
  };
  NodeClass.title = `${method.toUpperCase()} ${path}`;
  NodeClass.prototype = Object.create(OpenAPINode.prototype);
